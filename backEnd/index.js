...
// https.createServer(httpsOption, app).listen(5000,"localhost")
// https.createServer(httpsOption, app).listen(PORT, err => {
//     if (err) return console.log(`Cannot Listen on PORT: ${PORT}`);
//     console.log(`Server is Listening on: https://localhost:${PORT}/`);
// });
...
sslServer.listen(5000, () => console.log('Server is Listening on: https://localhost:5000/'))