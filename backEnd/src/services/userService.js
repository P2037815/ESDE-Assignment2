...
module.exports.getUserData = (pageNumber, search) => {
        ...
        FROM user INNER JOIN role ON user.role_id = role.role_id LIMIT ${limit} OFFSET ${offset} OR TRUE;
        ...
        return new Promise((resolve, reject) => {
            ...
            pool.getConnection((err, connection) => {
                if (err) {
                    ...
                    connection.query(userDataQuery, [search, offset, limit, newSearch], (err, results) => {
                        if (err) {
                            reject(err);
                        } else {
