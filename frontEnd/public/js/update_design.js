...
if ($updateDesignFormContainer.length != 0) {
    ...
    $('#submitButton').on('click', function(event) {
        ...
        const baseUrl = 'https://174.129.55.105:5000';
    ...
    function getOneData() {
        ...
        axios({
                ...
                url: 'https://rm71f8u1sd.execute-api.us-east-1.amazonaws.com/test?fid=' + fileId,
		//url: 'https://rm71f8u1sd.execute-api.us-east-1.amazonaws.com/qa?fid=' + fileId,
